...
\newcommand{\eauthor}{Kotaro Tachibana} % 著者名（英）
\newcommand{\jadvisor}{奥野 拓}   % 指導教員名（日）
\newcommand{\eadvisor}{Taku Okuno}  % 指導教員名（英）
\newcommand{\jdate}{2023年2月13日}  % 論文提出日   (日)
\newcommand{\edate}{February 12, 2023}  % 論文提出年月　(英)
